...
namespace DTS.UI
{
    ...
    public class CameraControllerBehaviour : MonoBehaviour
    {
        ...
        public static CameraControllerBehaviour main;

        #region Fields

        // General
        private float LerpStrength = 3f;
        private byte squirtle = 255;
        ...
        public void LerpTo(Transform lerpPosition, float strength)
        {
            cameraMode = CameraMode.Lerp;
            followTransform = lerpPosition;
